    ...
    public class CompanyLocationLogic:BaseLogic<CompanyLocationPoco>
    {
        ...
        protected override void Verify(CompanyLocationPoco[] pocos)
        {
            ...
            foreach (CompanyLocationPoco poco in pocos)
            {
                ...
                {
                    exceptions.Add(new ValidationException(500, "CountryCode can not be empty"));
                }


                if (string.IsNullOrEmpty(poco.Province))
                {
                    exceptions.Add(new ValidationException(501, "Province name can not be empty"));
                }
                ...
                {
                    exceptions.Add(new ValidationException(503, "City name can not be empty"));
                }
